 ...
 */
app.directive('rnCarousel', ['$compile', '$parse', '$swipe', '$document', '$window', 'CollectionManager', function($compile, $parse, $swipe, $document, $window, CollectionManager) {
      ...
      */
      ...
      return function(scope, iElement, iAttrs, controller) {
        ...
        function updateSlidePosition(forceSkipAnimation) {
            //console.log('forceSkipAnimation ', forceSkipAnimation);
